...
#define SHIP_OUT_FILE "tests/test_ship_out.txt"
#define SHIP_TEST_FILE "tests/test_ship.txt"
#define CLEAR_TEST_FILE "tests/test_clear_product.txt"
#define CLEAR_OUT_FILE "tests/test_clear_product_out.txt"
#define NEW_PRODUCT_OUT_FILE "tests/test_new_product_out.txt"
#define NEW_PRODUCT_TEST_FILE "tests/test_new_product.txt"
#define CHANGE_PRODUCT_AMOUNT_TEST_FILE "tests/test_change_product_amount.txt"
#define CHANGE_PRODUCT_AMOUNT_OUT_FILE "tests/test_change_product_amount_out.txt"
#define CHANGE_PRODUCT_AMOUNT_IN_ORDER_TEST_FILE "tests/test_change_product_amount_in_order.txt"
#define CHANGE_PRODUCT_AMOUNT_IN_ORDER_OUT_FILE "tests/test_change_product_amount_in_order_out.txt"
