...
#define INVENTORY_OUT_FILE "printed_inventory_safi_test.txt"
#define INVENTORY_OUT_FILE3 "printed_inventory_safi_test3.txt"
#define INVENTORY_OUT_FILE4 "printed_inventory_safi_test4.txt"
#define ORDER_OUT_FILE "printed_order_safi_test.txt"
#define ORDER_OUT_FILE3 "printed_order_safi_test3.txt"
#define BEST_SELLING_OUT_FILE "printed_best_selling_safitest.txt"
#define BEST_SELLING_OUT_FILE3  "printed_best_selling_safitest3.txt"
#define FILTERED_OUT_FILE "printed_filtered_safitest.txt"
#define FILTERED_OUT_FILE3 "printed_filtered_safitest3.txt"
#define FILTERED_OUT_FILE4 "printed_filtered_safitest4.txt"
